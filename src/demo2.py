...
class Pioneer:
    ...
    def speed_pioneer(self, max_linear_speed, angular_speed, lock_stop_simulation, error_phi, is_primitives = False):
    ...
    def move_arc(self, isleft):
        ...
        while number_iterations < max_iterations:
            ...
            left_speed, right_speed, _ = self.speed_pioneer(controller_linear, omega, lock_stop_simulation, 0, True)
    ...
    def make_trajectory(self):
        ...
        if abs(robot_x - target_x) < 0.01:
            self.move_to_position(pid_params, delta_time, robot_x, target_y)
            return
        else:
            self.move_to_position(pid_params, delta_time,  robot_x,  target_y - 0.4)
            ...
            self.move_to_position(pid_params, delta_time, target_x, robot_y)
